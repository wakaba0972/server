...
const result = await app.predict("/inference", [		
				"我是一支小小小小鳥", // string  in '需要合成的文本' Textbox component		
				...
				"This is a TTS (Text to Speech) voice. You can make the voice say anything, and it will be added to this board. ", // string  in '主参考音频的文本' Textbox component		
				"英文", // string  in '主参考音频的语种' Dropdown component		
				5, // number (numeric value between 1 and 100) in 'top_k' Slider component		
				...
				20, // number (numeric value between 1 and 200) in 'batch_size' Slider component		
				...
				0.3, // number (numeric value between 0.01 and 1) in '分段间隔(秒)' Slider component		
				3777428960, // number  in '随机种子' Number component		
				true, // boolean  in '保持随机' Checkbox component		
				true, // boolean  in '并行推理' Checkbox component		
				1.35, // number (numeric value between 0 and 2) in '重复惩罚' Slider component		
				"32", // string  in '采样步数(仅对V3/4生效)' Radio component		
				false, // boolean  in '音频超采样(仅对V3生效))' Checkbox component
	]);
